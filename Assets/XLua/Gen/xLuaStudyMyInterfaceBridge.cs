...
{
    public class xLuaStudyMyInterfaceBridge : LuaBase, xLuaStudy.MyInterface
    {
	    public static LuaBase __Create(int reference, LuaEnv luaenv)
		{
		    return new xLuaStudyMyInterfaceBridge(reference, luaenv);
		}
		
		public xLuaStudyMyInterfaceBridge(int reference, LuaEnv luaenv) : base(reference, luaenv)
        {
        }
