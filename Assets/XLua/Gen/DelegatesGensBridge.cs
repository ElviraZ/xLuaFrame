...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(int p0, int p1, out int p2, out int p3, out int p4)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp2(ref int p0, ref int p1, out int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new CallLuaFunctionByDelMultiReturn.DelAddingMulti(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(CallLuaFunctionByDelMultiReturn.DelAddingMultiRef))
			{
			    return new CallLuaFunctionByDelMultiReturn.DelAddingMultiRef(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(xLuaStudy.MyDelegate))
			{
			    return new xLuaStudy.MyDelegate(__Gen_Delegate_Imp3);
			}
