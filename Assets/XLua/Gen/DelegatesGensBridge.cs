...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp14(int p0, int p1, int p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(CallLuaFunctionByDelMultiReturn.DelAddingMulti))
			{
			    return new CallLuaFunctionByDelMultiReturn.DelAddingMulti(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(CallLuaFunctionByDelMultiReturn.DelAddingMultiRef))
			{
			    return new CallLuaFunctionByDelMultiReturn.DelAddingMultiRef(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(xLuaStudy.MyDelegate))
			{
			    return new xLuaStudy.MyDelegate(__Gen_Delegate_Imp2);
			}
			...
			{
			    return new System.Action<int, int, int>(__Gen_Delegate_Imp14);
			}
		
		    if (type == typeof(System.Func<int, int, int>))
			{
			    return new System.Func<int, int, int>(__Gen_Delegate_Imp15);
			}
